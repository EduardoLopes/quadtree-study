describe("QuadTree", function() {
  ...
  it("#insert should insert entities", function() {
    ...
    expect(quadTree.entities.length).toBe(2);
  ...
  it("level 0: should have 2 entities", function() {
  ...
  it("level 2: should have 1 entities", function() {

    expect(quadTree.nodes[2].nodes[0].entities.length).toBe(1);

  });

  it("level 3: should have 0 nodes", function() {

    expect(quadTree.nodes[2].nodes[0].nodes.length).toBe(0);

  });

  it("#query should return 2 entities", function() {

    var query = quadTree.query( new Rectangle(400, 400, 100, 400) );
